...
scenarios("profiling-tls.feature")
...
def deploy_and_integrate_ssc(juju: Juju):
...
def emit_profile_tls(juju: Juju, ca_cert_path):
...
def ingest_profile_tls(juju: Juju, ca_cert_path):
    pyroscope_ip = get_unit_ip_address(juju, PYROSCOPE_APP, 0)
