...
module "pyroscope_coordinator" {
  source      = "git::https://github.com/canonical/pyroscope-operators//coordinator/terraform?ref=track/2"
  model       = var.model
  channel     = var.channel
...
module "pyroscope_querier" {
  source      = "git::https://github.com/canonical/pyroscope-operators//worker/terraform?ref=track/2"
